...
export default {
  ...
  methods: {
    ...
    async updateUser() {
      ...
      try {
        const response = await fetch("https://flixtaneuse.onrender.com/api/users/profile/modif-user", {
          method: "POST",
          headers: {
  ...
  async created() {
    try {
      ...
      const likedResponse = await fetch("https://flixtaneuse.onrender.com/api/users/profile/liked-films", {
        method: "GET",
        headers: {
          Authorization: `Bearer ${token}`,
        },
      ...
      const watchLaterResponse = await fetch("https://flixtaneuse.onrender.com/api/users/profile/watch-later", {
        method: "GET",
        headers: {
          Authorization: `Bearer ${token}`,
        },
      ...
      const ratedResponse = await fetch("https://flixtaneuse.onrender.com/api/users/profile/rated-films", {
        method: "GET",
        headers: {
          Authorization: `Bearer ${token}`,
        },
